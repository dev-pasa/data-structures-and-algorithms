...
namespace FizzBuzzTree.Classes
{
    public class BinaryTree
    {
        ...
        public void PreOrder(Node root, List<object> valuesInPreOrder)
        {
            //if node is null
            if (root == null) return;
        ...
        public void InOrder(Node root, List<object> valuesInOrder)
        {
            //if node is null
            if (root == null) return;
            //Else add values to list and call recursively on left and right nodes
        ...
        public void PostOrder(Node root, List<object> valuesInPostOrder)
        {
            //if node is null
            if (root == null) return;
            //Else add values to list and call recursively on left and right nodes
